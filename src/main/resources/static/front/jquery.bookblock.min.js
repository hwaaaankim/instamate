...
(function (f, g, d) {
  ...
  e.addTest("csstransformspreserve3d", function () {
    ...
    l = l
      .replace(/([A-Z])/g, function (n, m) {
        return "-" + m.toLowerCase();
      })
      .replace(/^ms-/, "-ms-");
    e.testStyles("#modernizr{" + l + ":" + k + ";}", function (m, n) {
      j = g.getComputedStyle
        ? getComputedStyle(m, null).getPropertyValue(l)
        : "";
    });
    return j === k;
  });
  ...
  f.BookBlock.prototype = {
    _init: function (j) {
      ...
      this.support =
        e.csstransitions && e.csstransforms3d && e.csstransformspreserve3d;
      this._initEvents();
    ...
    _navigate: function (j, k) {
      ...
      if (k !== d) {
        ...
        if (
          (j === "next" && this.options.direction === "ltr") ||
          (j === "prev" && this.options.direction === "rtl")
        ) {
          ...
          if (
            (j === "prev" && this.options.direction === "ltr") ||
            (j === "next" && this.options.direction === "rtl")
          ) {
    ...
    _layoutNoSupport: function (k) {
      ...
      var j =
        (k === "next" && this.current === this.itemsCount - 1) ||
        (k === "prev" && this.current === 0);
    ...
    _layout: function (l) {
      ...
      o.css({
        ...
        if (f(y.target).hasClass("bb-page")) {
          ...
          v.isAnimating = false;
          var x =
            (l === "next" && v.current === v.itemsCount - 1) ||
            (l === "prev" && v.current === 0);
      ...
      setTimeout(function () {
        ...
        if (v.options.shadows && !v.end) {
          t.css({ opacity: l === "next" ? v.options.shadowFlip : 0 });
          w.css({ opacity: l === "next" ? 0 : v.options.shadowFlip });
          r.css({ opacity: l === "next" ? v.options.shadowSides : 0 });
          s.css({ opacity: l === "next" ? 0 : v.options.shadowSides });
        }
      }, 25);
    },
